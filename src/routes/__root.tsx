...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Foco Total — Plataforma de estudos para concursos" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Foco Total" },
      { property: "og:title", content: "Foco Total — Plataforma de estudos para concursos" },
      {
